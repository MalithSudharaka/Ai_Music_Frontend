  ...
  return (
    <div className="min-h-screen bg-[#081028]">
      <div className="mx-4 md:mx-8 pt-6 md:pt-8">
        <h1 className="text-2xl md:text-3xl font-bold text-white mb-6 md:mb-8">Users <span className="text-base md:text-lg font-normal text-gray-400">Add Users</span></h1>
