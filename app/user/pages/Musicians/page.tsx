                ...
                <div className='col-span-1 flex justify-center md:justify-start mt-10 md:mt-0'>
                    <div className='text-center md:text-left'>
                        ...
                        <div className='items-center justify-center mt-4'>
                            ...
                            <button className='bg-blue-500  mt-4 text-white px-2 py-2 md:px-4 md:py- xl:px-6 xl:py-1 rounded-full hover:bg-blue-600 transition-colors duration-200 font-bold text-sm'>
                            Show Profile
                        </button>
